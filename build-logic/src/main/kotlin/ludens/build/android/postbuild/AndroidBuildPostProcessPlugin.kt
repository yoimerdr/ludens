    ...
    override fun apply(project: Project) {
        ...
        project.pluginManager.withPlugin("com.android.application") {
            ...
            androidComponents.onVariants { variant ->
                ...
                val includedVariants = config.includeVariants
                    .flatMap { it.split(",") }
                    .map { it.trim() }

                val isVariantIncluded = includedVariants.contains("all") ||
                    includedVariants.contains(variantName)
                ...
                fun registerPostProcessTask(
                    ...
                    val resolvedOutputDir = config.outputDir
                        .replace("{buildType}", variantName)
                    ...
                    if (outputDirFile.isAbsolute) {
                        ...
                        this.targetOutputDir.set(project.rootProject.layout.projectDirectory.dir(resolvedOutputDir))
                    }
                ...
                val apkBuildTasks = project.tasks.matching {
                    it.name == "package${capitalizedVariant}" ||
                        it.name == "package${capitalizedVariant}Apk" ||
                ...
                val bundleBuildTasks = project.tasks.matching {
                    it.name == "package${capitalizedVariant}Bundle" ||
                        it.name == "sign${capitalizedVariant}Bundle" ||
                        it.name == "bundle${capitalizedVariant}"
                }
