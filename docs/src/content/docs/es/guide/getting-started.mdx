...
1. Clona el repositorio.
   - Para usar la versión de lanzamiento `v0.4.0`:
     ```bash
     git clone --branch v0.4.0 https://github.com/yoimerdr/ludens.git
     ```
...
<FileTree>
- ludens/
  - shared/ Módulo compartido KMP (código común, lógica, UI)
    - src/
      - commonMain/
        - composeResources/
          - files/
            - www/ Recursos de juego internos (Opción B)
  - androidApp/ Módulo de aplicación Android (punto de entrada, manifest, iconos)
  - project/ Fuente principal de verdad para assets
    - assets/
      - fonts/ Fuentes tipográficas personalizadas (sincronización auto)
      - languages/ Fuente de verdad de localización (archivos xml)
    - www/ Archivos de juego de RPG Maker (Opción A, sincronización auto)
