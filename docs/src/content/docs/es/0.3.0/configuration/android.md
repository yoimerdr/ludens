...
slug: es/0.3.0/configuration/android
---
...
![Uso de Image Asset Studio para actualizar el icono de la aplicación.](../../../../../assets/images/guide/0.3.0/ludens-application-icon.png)
