...
description: Prerrequisitos y configuración del entorno para compilar juegos de
  RPG Maker MV y MZ para móviles con Ludens.
head:
  - tag: meta
    attrs:
      name: keywords
      content: rpg maker mv android port, rpg maker mz android, rpg maker mv ios, rpg
        maker mz ios, compose multiplatform rpg maker, configurar rpg maker
        móvil
slug: es/0.3.0/guide/getting-started
---
...
![Pantalla de bienvenida de Android Studio donde se puede verificar la versión instalada.](../../../../../assets/images/guide/0.3.0/android-studio-setup.png)
...
Necesitas tu proyecto de RPG Maker exportado para despliegue web. Consulta la sección [Exportar el Juego](/es/0.3.0/guide/game-export/) para más detalles.
...
![El plugin YDP\_Ludens.js debe colocarse en la parte superior de la lista para asegurar su correcta carga.](../../../../../assets/images/guide/0.3.0/plugin-manager-ydp_ludens.png)
...
1. Clona el repositorio.
   - Para usar la versión de lanzamiento `v0.3.0`:
     ```bash
     git clone --branch v0.3.0 https://github.com/yoimerdr/ludens.git
     ```
...
Por defecto, la aplicación Ludens está configurada para ejecutarse en modo Horizontal (`sensorLandscape`). Si tu juego está diseñado para modo Vertical (Portrait), necesitarás cambiar esta configuración en `ludens.properties`. Consulta la guía de [Configuración Android](/es/0.3.0/configuration/android/#configuración-del-manifest) para más detalles.

![Vista del proyecto en Android Studio una vez finalizada la sincronización de Gradle.](../../../../../assets/images/guide/0.3.0/ludens-android-studio-project.png)
...
1. [Exportar tu juego](/es/0.3.0/guide/game-export/) desde RPG Maker.
2. [Configurar y compilar](/es/0.3.0/guide/build/android/) tu APK de Android.
