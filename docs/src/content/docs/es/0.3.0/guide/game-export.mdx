...
slug: es/0.3.0/guide/game-export
---
...
![Selecciona la opción Android / iOS al desplegar tu juego.](../../../../../assets/images/guide/0.3.0/ludens-rpgmmv-deployment.png)
...
![Vista de Android Studio mostrando la carpeta www y el archivo index.html dentro de composeResources/files.](../../../../../assets/images/guide/0.3.0/ludens-android-studio-files.png)
...
Con tus assets en su lugar, procede a [configurar y compilar](/es/0.3.0/guide/build/android/) tu aplicación.
