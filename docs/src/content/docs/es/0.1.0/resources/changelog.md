...
slug: es/0.1.0/resources/changelog
---
...
* Arreglado que los controles en pantalla no se mostraran cuando el plugin YDP\_Ludens está deshabilitado o no presente
