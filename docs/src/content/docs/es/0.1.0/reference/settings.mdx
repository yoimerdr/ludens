...
slug: es/0.1.0/reference/settings
---
...
Para más detalles sobre cómo funciona el sistema de posicionamiento, consulta la referencia de [Elementos Posicionables](/es/0.1.0/reference/positions/).
