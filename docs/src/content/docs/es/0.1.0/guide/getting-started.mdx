  ...
  - tag: meta
    attrs:
      ...
      content: rpg maker mv android port, rpg maker mz android, rpg maker mv ios, rpg
        ...
        móvil
slug: es/0.1.0/guide/getting-started
---
...
Necesitas tu proyecto de RPG Maker exportado para despliegue web. Consulta la sección [Exportar el Juego](/es/0.1.0/guide/game-export/) para más detalles.
...
![El plugin YDP\_Ludens.js debe colocarse en la parte superior de la lista para asegurar su correcta carga.](../../../../../assets/images/guide/plugin-manager-ydp_ludens.png)
...
1. Clona el repositorio.
   - Para usar la versión de lanzamiento `v0.1.0`:
     ```bash
     git clone --branch v0.1.0 https://github.com/yoimerdr/ludens.git
     ```
...
Por defecto, la aplicación Ludens está configurada para ejecutarse en modo Horizontal (`sensorLandscape`). Si tu juego está diseñado para modo Vertical (Portrait), necesitarás cambiar esta configuración en el Android Manifest. Consulta la guía de [Configuración Android](/es/0.1.0/configuration/android/#orientación-del-juego) para más detalles.
...
1. [Exportar tu juego](/es/0.1.0/guide/game-export/) desde RPG Maker.
2. [Configurar y compilar](/es/0.1.0/guide/build/android/) tu APK de Android.
