...
description: Prerequisites and environment setup for building with Ludens.
---

import { FileTree } from '@astrojs/starlight/components';

This guide walks you through the prerequisites and initial setup required to build your RPG Maker MV/MZ game as a native Android application using Ludens.
...
You need your RPG Maker project exported for web deployment. See the [Game Export](/docs/guide/game-export/) section for details.
...
By default, the Ludens application is configured to run in Landscape mode (`sensorLandscape`). If your game is designed for Portrait mode, you will need to change this configuration in the Android Manifest. See the [Android Configuration](/docs/configuration/android/#game-orientation) guide for details.
...
1. [Export your game](/docs/guide/game-export/) from RPG Maker.
2. [Configure and build](/docs/guide/build/android/) your Android APK.
