...
**Tip**: You can use the plugin **[YDP_CrossAssets](https://github.com/yoimerdr/rpgm-plugins)** to automatically normalize file paths and avoid this issue.
:::
...
With your assets in place, proceed to [configure and build](/guide/build/android/) your application.
