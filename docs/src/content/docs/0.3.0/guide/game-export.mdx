...
![Select the Android / iOS option when deploying your game.](../../../../assets/images/guide/0.3.0/ludens-rpgmmv-deployment.png)
...
![Android Studio view showing the www folder and index.html file inside composeResources/files.](../../../../assets/images/guide/0.3.0/ludens-android-studio-files.png)
...
With your assets in place, proceed to [configure and build](/0.3.0/guide/build/android/) your application.
