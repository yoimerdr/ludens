...
slug: 0.3.0/guide/getting-started
---
...
![Android Studio welcome screen where you can verify the installed version.](../../../../assets/images/guide/0.3.0/android-studio-setup.png)
...
You need your RPG Maker project exported for web deployment. See the [Game Export](/0.3.0/guide/game-export/) section for details.
...
![The YDP\_Ludens.js plugin must be placed at the top of the list to ensure correct loading.](../../../../assets/images/guide/0.3.0/plugin-manager-ydp_ludens.png)
...
1. Clone the repository.
   - To use the `v0.3.0` release version:
     ```bash
...
By default, the Ludens application is configured to run in Landscape mode (`sensorLandscape`). If your game is designed for Portrait mode, you will need to change this configuration in `ludens.properties`. See the [Android Configuration](/0.3.0/configuration/android/#manifest-configuration) guide for details.

![View of the project in Android Studio once Gradle sync is complete.](../../../../assets/images/guide/0.3.0/ludens-android-studio-project.png)
...
1. [Export your game](/0.3.0/guide/game-export/) from RPG Maker.
2. [Configure and build](/0.3.0/guide/build/android/) your Android APK.
