...
slug: 0.3.0/guide/build/android
---
...
the [Android Configuration](/0.3.0/configuration/android/) guide.
...
![Accessing the configurations menu.](../../../../../assets/images/guide/0.3.0/ludens-build-configurations.png)

2. Add a new **Gradle** task.

![Creating a new Gradle task.](../../../../../assets/images/guide/0.3.0/ludens-build-configurations-gradle-task.png)

3. Name the task (e.g., `assembleDebug`) and in the **Arguments** field type: `assembleDebug`.

![Configuring the task arguments.](../../../../../assets/images/guide/0.3.0/ludens-build-configurations-gradle-task-assembleDebug.png)
...
![Successful build result.](../../../../../assets/images/guide/0.3.0/ludens-build-debug.png)
...
![Starting the signing wizard.](../../../../../assets/images/guide/0.3.0/ludens-build-configurations-sign.png)
...
3. Configure your Keystore:
   ...
   **Create New** — If you don't have one, click **Create new...**.
   ...
   ![Creating a new Keystore. Keep your password and the .jks file safe.](../../../../../assets/images/guide/0.3.0/ludens-build-configurations-sign-creation.png)

   **Use Existing** — If you already have one, load it and enter credentials.

   ![Keystore credentials.](../../../../../assets/images/guide/0.3.0/ludens-build-configurations-sign-use.png)

4. Select the **release** build flavor and click **Create**.

![Output variant selection.](../../../../../assets/images/guide/0.3.0/ludens-build-configurations-sign-release.png)

5. **Result**:

![Notification of successfully generated APK.](../../../../../assets/images/guide/0.3.0/ludens-build-release.png)
...
![Build result from Gradle.](../../../../../assets/images/guide/0.3.0/ludens-build-release-gradle.png)
