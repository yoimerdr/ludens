...
slug: 0.1.0/guide/getting-started
---
...
You need your RPG Maker project exported for web deployment. See the [Game Export](/0.1.0/guide/game-export/) section for details.
...
![The YDP\_Ludens.js plugin must be placed at the top of the list to ensure correct loading.](../../../../assets/images/guide/plugin-manager-ydp_ludens.png)
...
1. Clone the repository.
   - To use the `v0.1.0` release version:
     ```bash
...
By default, the Ludens application is configured to run in Landscape mode (`sensorLandscape`). If your game is designed for Portrait mode, you will need to change this configuration in the Android Manifest. See the [Android Configuration](/0.1.0/configuration/android/#game-orientation) guide for details.
...
1. [Export your game](/0.1.0/guide/game-export/) from RPG Maker.
2. [Configure and build](/0.1.0/guide/build/android/) your Android APK.
