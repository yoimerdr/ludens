 ...
 * configurations, tool settings, system settings, and quick actions. It serves as the single
 ...
 * @property action The [ActionSettingsState] containing quick action configurations.
 */
@Immutable
data class SettingsState(
    ...
    val action: ActionSettingsState = ActionSettingsState()
) {
    /**
