...
/**
 * D-pad Left button icon.
 *
 * Icon representing the left direction button of a modern directional pad.
 * */
val LudensIcons.Filled.DpadLeft: ImageVector
    get() {
        if (_DpadLeft != null) {
            return _DpadLeft!!
        }
...
private var _DpadLeft: ImageVector? = null
