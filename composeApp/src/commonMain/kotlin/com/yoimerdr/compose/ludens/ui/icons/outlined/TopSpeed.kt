 ...
 * Top Speed icon.
 *
 * This icon is a transformation of the outlined `Top Speed` icon from Fluent Icons.
 */
val LudensIcons.Outlined.TopSpeed: ImageVector
    get() {
        if (_TopSpeed != null) {
            return _TopSpeed!!
        }
        _TopSpeed =
            ImageVector.Builder(
                ...
                path(fill = SolidColor(Color.White)) {
                    ...
                    lineToRelative(-6.257f, 8.476f)
                    close()
                    moveTo(13.85f, 12.798f)
                    lineTo(11.256f, 16.312f)
                    lineTo(11.216f, 16.374f)
                    arcToRelative(
                        0.57f,
                        0.57f,
                        0f,
